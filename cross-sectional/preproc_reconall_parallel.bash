...
#FINISH_NOTIFICATION_EMAIL_ADDRESS="tim.schaefer@kgu.de"  # leave empty if you do not want an email. Using this requires a working sendmail/MX setup on the workstation.
