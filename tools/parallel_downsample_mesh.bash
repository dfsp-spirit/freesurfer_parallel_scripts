#!/bin/bash
# parallel_downsample_mesh.bash -- downsample meshes in parallel over a number of subjects.
#
######################### IMPORTANT #############################
...
# 3) path/to/parallel_downsample_mesh.bash ./subjects.txt

APPTAG="[PAR_DOWN_MESH]"
...
CARGO_SCRIPT="${EXEC_PATH_OF_THIS_SCRIPT}/downsample_mesh_subject.bash"
