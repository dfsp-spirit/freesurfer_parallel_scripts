...
if [ -z "$subject_id" ]; then
  ...
  echo "Note: You can redirect the output of this script into a file to create a new table."
  exit 1
fi
...
if [ -z "$res" ]; then
    ...
    >&2 echo "ERROR: (cont.): You can use the 'qdec_list_subjects.bash' script to list all subjects in the file."
    exit 1
fi
